...
async function downloadChapterManga4life(slug, chapter) {
  ...
  for (let i = 1; i <= totalPages; i++) {
    ...
    images.push(`https://official-ongoing-1.ivalice.us/manga/${slug}${directory}/${chNumber}-${pageNumber}.png`);
  }
...
module.exports = {
  searchMangaManga4life,
  fetchMangaDetailsManga4life,
  downloadChapterManga4life
};
